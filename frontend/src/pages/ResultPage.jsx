            ...
            <main className="flex-1 overflow-y-auto bg-background-light dark:bg-[#0a0c16] relative pb-20">
                ...
                <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-8">
                    ...
                    <motion.section 
                        ...
                        className="relative rounded-xl overflow-hidden h-64 flex flex-col justify-center px-8 md:px-12 border border-glass-border group glass"
                    >
                        ...
                        <div className="relative z-20 flex flex-col md:flex-row justify-between items-center gap-10">
                            <div className="text-center md:text-left space-y-4">
                                ...
                                <motion.h1 
                                    ...
                                    className="text-3xl md:text-4xl font-black font-display tracking-tight text-white shadow-sm"
                                >
                                ...
                                <motion.p 
                                    ...
                                    className="text-slate-400 font-medium font-mono text-sm"
                                >
                            ...
                            >
                                <div className="w-32 h-32 md:w-40 md:h-40 relative flex items-center justify-center">
                                    <svg className="absolute inset-0 w-full h-full -rotate-90 drop-shadow-[0_0_15px_rgba(51,82,255,0.4)]">
                                        <circle
                                            cx="50%" cy="50%" r="42%"
                                            className="stroke-glass-border/50 stroke-[6px] fill-none"
                                        />
                                        <motion.circle
                                            cx="50%" cy="50%" r="42%"
                                            initial={{ strokeDashoffset: 264 }}
                                            animate={{ strokeDashoffset: 264 - (264 * (interview.finalScore || 0)) / 100 }}
                                            transition={{ duration: 1.5, delay: 0.8, ease: "easeOut" }}
                                            className="fill-none stroke-primary stroke-[6px]"
                                            strokeDasharray="264"
                                            strokeLinecap="round"
                                        />
                                    </svg>
                    ...
                    <div className="grid lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <motion.section 
                                ...
                                className="glass rounded-xl p-8 border border-glass-border relative overflow-hidden"
                            >
                            ...
                            <div className="space-y-6">
                                <motion.h2 
                                    ...
                                    viewport={{ once: true }}
                                    className="font-display text-xl font-bold pt-4 text-white"
                                >
                                    Neural Breakdown
                                </motion.h2>
                        ...
                        <div className="space-y-6">
                            <div className="sticky top-24 space-y-6">
                                ...
                                <motion.div 
                                    ...
                                    className="glass rounded-xl p-6 border border-glass-border relative overflow-hidden group"
                                >
